...
const MovieListWL = (allmovies: any[]) => {
  const controls2 = useAnimation();
  const { watchlater } = useContext(UserContext)!;
    ...
    <div className="w-full h-72 flex flex-col ">
      <div className="relative flex flex-row w-full">
        ...
        <motion.div
          ref={containerRef}
          animate={controls2}
          className="my-3 w-full h-fit flex flex-row overflow-auto scroll-smooth  scrollbar scrollbar-track-transparent scrollbar-thumb-transparent"
        >
          {watchlater
